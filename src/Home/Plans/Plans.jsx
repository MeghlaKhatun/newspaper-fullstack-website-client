...
const Plans = () => {
    return (
        <div className="">
            <div className="max-w-7xl mx-auto bg-black py-10 my-10 px-10">
                <div className="grid grid-cols-3 gap-6">

                    <div className="border-4 border-gray-300 h-[400px]">
                        <div className="p-5  flex justify-between items-center">
                            <div>
                                <h2 className="text-2xl text-white font-bold">Premium Individual</h2>
                            </div>
                            <div>                              
                                <h2 className="text-xl text-center font-medium text-white">Free</h2>
